                ...
                <div class="sm:flex sm:items-start">
                    @if($service->icon)
                        <div class="flex-shrink-0 sm:mr-4 mb-4 sm:mb-0">
                            <div class="w-16 h-16 bg-blue-100 rounded-xl flex items-center justify-center mx-auto sm:mx-0">
                    ...
                    <div class="flex-1 text-center sm:text-left">
                        <div class="sm:flex sm:items-center">
                            ...
                            @if($service->is_featured)
                                <span class="mt-2 sm:mt-0 sm:ml-3 inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-yellow-100 text-yellow-800">
            ...
            <div class="mt-8 lg:mt-0 lg:col-span-4">
                <div class="bg-white shadow-sm ring-1 ring-gray-900/5 rounded-xl overflow-hidden">
                    <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
                        <h3 class="text-lg font-semibold text-gray-900">Стоимость продукта</h3>
                    </div>
                    <div class="px-6 py-4">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="lg:grid lg:grid-cols-12 lg:gap-8">
            ...
            <div class="lg:col-span-8">
                <div class="bg-white shadow-sm ring-1 ring-gray-900/5 rounded-xl overflow-hidden">
                    <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
                        <h2 class="text-lg font-semibold text-gray-900">Описание продукта</h2>
                    </div>
                    <div class="px-6 py-6">
            ...
            <div class="mt-8 lg:mt-0 lg:col-span-4 space-y-6">
                ...
                @if($relatedServices->count() > 0)
                    <div class="bg-white shadow-sm ring-1 ring-gray-900/5 rounded-xl overflow-hidden">
                        <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
                            <h3 class="text-lg font-semibold text-gray-900">Другие продукты категории</h3>
                        </div>
                        <div class="px-6 py-4">
                            <ul class="space-y-3">
