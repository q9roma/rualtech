            ...
            <div class="mt-8 lg:mt-0 lg:col-span-4">
                <div class="bg-white shadow-sm ring-1 ring-gray-900/5 rounded-xl overflow-hidden">
                    ...
                    <div class="px-6 py-4">
                        ...
                        <div class="mt-6">
                            <div class="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600">
                                office@rualtech.ru
                            </div>
                        </div>
                        
                        <div class="mt-3">
                            <div class="w-full flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white">
                                +7 (495) 275-35-33
                            </div>
                        </div>
                    </div>
