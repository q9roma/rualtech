...
<head>
    ...
    <!-- Modal functions -->
    <script>
        // Глобальная функция для открытия модального окна заказа
...
<body class="min-h-screen flex flex-col bg-gray-50 text-gray-900 pt-20">
    ...
    <div class="flex flex-col flex-1 min-h-0">
        ...
        <script>
            ...
            })(window, document, 'script', 'https://mc.yandex.ru/metrika/tag.js?id=108760077', 'ym');
        ...
        <noscript>
            <div>
                <img src="https://mc.yandex.ru/watch/108760077" class="absolute left-[-9999px]" width="1" height="1" alt="">
            </div>
        </noscript>
        {{-- /Yandex.Metrika counter --}}
    </footer>
